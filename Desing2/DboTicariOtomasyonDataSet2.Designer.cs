...
namespace Desing2 {
    ...
    public partial class DboTicariOtomasyonDataSet2 : global::System.Data.DataSet {
        ...
        public partial class TBL_GIDERLERDataTable : global::System.Data.TypedTableBase<TBL_GIDERLERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TBL_GIDERLERRow AddTBL_GIDERLERRow(string YIL, string AY, decimal ELEKTRIK, decimal SU, decimal DOGALGAZ, decimal INTERNET, decimal MAASLAR, decimal EKSTRA, string NOTLAR) {
...
namespace Desing2.DboTicariOtomasyonDataSet2TableAdapters {
    ...
    public partial class TBL_GIDERLERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_GIDERLER] ([YIL], [AY], [ELEKTRIK], [SU], [DOGALGAZ], [INTERNET], [MAASLAR], [EKSTRA], [NOTLAR]) VALUES (@YIL, @AY, @ELEKTRIK, @SU, @DOGALGAZ, @INTERNET, @MAASLAR, @EKSTRA, @NOTLAR);
SELECT ID, YIL, AY, ELEKTRIK, SU, DOGALGAZ, INTERNET, MAASLAR, EKSTRA, NOTLAR FROM TBL_GIDERLER WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TBL_GIDERLER] SET [YIL] = @YIL, [AY] = @AY, [ELEKTRIK] = @ELEKTRIK, [SU] = @SU, [DOGALGAZ] = @DOGALGAZ, [INTERNET] = @INTERNET, [MAASLAR] = @MAASLAR, [EKSTRA] = @EKSTRA, [NOTLAR] = @NOTLAR WHERE (([ID] = @Original_ID) AND ((@IsNull_YIL = 1 AND [YIL] IS NULL) OR ([YIL] = @Original_YIL)) AND ((@IsNull_AY = 1 AND [AY] IS NULL) OR ([AY] = @Original_AY)) AND ((@IsNull_ELEKTRIK = 1 AND [ELEKTRIK] IS NULL) OR ([ELEKTRIK] = @Original_ELEKTRIK)) AND ((@IsNull_SU = 1 AND [SU] IS NULL) OR ([SU] = @Original_SU)) AND ((@IsNull_DOGALGAZ = 1 AND [DOGALGAZ] IS NULL) OR ([DOGALGAZ] = @Original_DOGALGAZ)) AND ((@IsNull_INTERNET = 1 AND [INTERNET] IS NULL) OR ([INTERNET] = @Original_INTERNET)) AND ((@IsNull_MAASLAR = 1 AND [MAASLAR] IS NULL) OR ([MAASLAR] = @Original_MAASLAR)) AND ((@IsNull_EKSTRA = 1 AND [EKSTRA] IS NULL) OR ([EKSTRA] = @Original_EKSTRA)) AND ((@IsNull_NOTLAR = 1 AND [NOTLAR] IS NULL) OR ([NOTLAR] = @Original_NOTLAR)));
SELECT ID, YIL, AY, ELEKTRIK, SU, DOGALGAZ, INTERNET, MAASLAR, EKSTRA, NOTLAR FROM TBL_GIDERLER WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Desing2.Properties.Settings.Default.DboTicariOtomasyonConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, YIL, AY, ELEKTRIK, SU, DOGALGAZ, INTERNET, MAASLAR, EKSTRA, NOTLAR FRO" +
                "M dbo.TBL_GIDERLER";
        ...
        public virtual int Insert(string YIL, string AY, global::System.Nullable<decimal> ELEKTRIK, global::System.Nullable<decimal> SU, global::System.Nullable<decimal> DOGALGAZ, global::System.Nullable<decimal> INTERNET, global::System.Nullable<decimal> MAASLAR, global::System.Nullable<decimal> EKSTRA, string NOTLAR) {
            if ((YIL == null)) {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<decimal> Original_EKSTRA, 
                    string Original_NOTLAR) {
            return this.Update(YIL, AY, ELEKTRIK, SU, DOGALGAZ, INTERNET, MAASLAR, EKSTRA, NOTLAR, Original_ID, Original_YIL, Original_AY, Original_ELEKTRIK, Original_SU, Original_DOGALGAZ, Original_INTERNET, Original_MAASLAR, Original_EKSTRA, Original_NOTLAR, Original_ID);
        }
    }
